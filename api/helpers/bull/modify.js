...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const findRepeatableJob = repeatableJobs.find(job => job.id === jobId);
      if (findRepeatableJob) {
        await queueInstance.removeRepeatableByKey(findRepeatableJob.key);
      }
      queueInstance.add({}, {
        ...jobConfig,
        ...jobDefaultOptions,
